...
class ClientMainWindow(QMainWindow):
    ...
    def set_disabled_input(self):
        self.ui.label_new_message.setText('To select a recipient '
                                          'double click on it in the contacts window.')
    ...
    def set_active_user(self):
        self.ui.label_new_message.setText(f'Enter a message for {self.current_chat}:')
    ...
    def add_contact(self, new_contact):
        try:
            ...
            logger.info(f'Add contact successful {new_contact}')
            self.messages.information(self, 'Success', 'Add contact successful.')
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.clients_list_update()
            logger.info(f'Contact was deleted {selected}')
            self.messages.information(self, 'Success', 'Contact was deleted.')
            item.close()
    ...
    def send_message(self):
        ...
        try:
            ...
            logger.debug(f'Sent message for {self.current_chat}: {message_text}')
            self.history_list_update()
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                if self.messages.question(self, 'New message',
                                          ...
                                          f'open the chat?', QMessageBox.Yes,
    ...
    def connection_lost(self):
        self.messages.warning(self, 'Connection failed', 'Server connection lost. ')
        self.close()
